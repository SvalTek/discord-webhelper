...
module.exports.BASE_URL = "https://discord.com/api/v8/";
...
module.exports.OAUTH_USER_GUILDS =                                            () => `/users/@me/guilds`;
module.exports.OAUTH_USER_GUILD =                                      (guildId) => `/users/@me/guilds/${guildId}/member`;
module.exports.OAUTH_USER_GUILD_JOIN =                          (guildId,userId) => `/users/@me/guilds/${guildId}/${userId}`;
module.exports.OAUTH_USER_CONNECTIONS =                                       () => `/users/@me/connections`;
module.exports.OAUTH_USER =                                                   () => `/users/@me`;
